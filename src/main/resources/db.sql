...
insert into ACCOUNTS values(default, 'PENDING', 'drakoniukas@email.lt', '+3706666666', 'LT123', 'EUR', '110.11' );
...
insert into ACCOUNTS values(default, 'SUSPENDED', 'asilas@email.lt', '6969696969', 'LT456', 'EUR', -13.23 );


insert into TRANSACTIONS values(default, 1, 2, 'EUR', 100, 'PENDING');
insert into TRANSACTIONS values(default, 1, 2, 'EUR', 500, 'CLEARED');
insert into TRANSACTIONS values(default, 1, 2, 'EUR', 200, 'CLEARED');